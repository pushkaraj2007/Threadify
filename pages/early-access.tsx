...
const EarlyAccess: NextPage = () => {
  const sendData = async (e: any) => {
    ...
    if (twitterUsername.length < 1) {
      return toast.error("Invalid twitter username");
    }
    ...
    <main className="h-[82vh] bg-gray-100 pt-4 dark:bg-gray-900 flex items-center justify-center text-gray-900 dark:text-gray-200">
      ...
      <div className="flex w-full justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg text-center px-4 mt-2">
          ...
          <form className="flex flex-col items-center mt-4" onSubmit={sendData}>
            <div className="mt-6">
              ...
              <input
                className="bg-transparent w-72 pl-7 border-b outline-none border-b-orange-400"
                id="email"
            ...
            <div className="mt-6">
              ...
              <input
                className="bg-transparent w-72 border-b pl-7 outline-none border-b-orange-400"
                id="twitterUsername"
                type="text"
            ...
            <button
              className="mt-6 px-4 py-2 font-bold text-white transition-all bg-blue-500 rounded hover:bg-blue-700"
              type="submit"
            >
              Sign Up
            </button>
