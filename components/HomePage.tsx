    ...
    return (
        <section className="text-gray-600 body-font">
            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <button name="Get Started" className="flex px-8 py-2 mx-auto mt-16 text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600" onClick={()=> signIn('twitter', { callbackUrl: 'http://localhost:3000/api/twitter/user' })}>Get Started</button>
            </div>
        </section>
    )
}
