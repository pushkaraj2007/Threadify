                ...
                <div className="flex flex-wrap -m-4">
                    ...
                    <div className="xl:w-1/3 md:w-1/2 p-4">
                        <div className="border border-gray-200 p-6 rounded-lg">
                            ...
                            <p className="leading-relaxed text-base">Threadify helps you to manage your threads easily with its super useful features.</p>
                        </div>
                    </div>
                    <div className="xl:w-1/3 md:w-1/2 p-4">
                        <div className="border border-gray-200 p-6 rounded-lg">
                    ...
                    <div className="xl:w-1/3 md:w-1/2 p-4">
                        <div className="border border-gray-200 p-6 rounded-lg">
                            ...
                            <p className="leading-relaxed text-base">Threadify believes in security is the priority, Thats why we never share your information with anyone else.</p>
                        </div>
                    </div>
                </div>
